			...
			<div class="col-auto col-x1-2 px-sm-2 px-0 navigasi">
				...
				<table class="table">
					...
					<tbody>
						...
						include 'koneksi.php';
						$no = 1;
						$tgl = isset($_GET['tanggal']);
						if(isset($_GET['tanggal'])){
							$sql = mysqli_query($koneksi,"select * from perjalanan where tanggal='$tgl'");
						}else{
							$sql = mysqli_query($koneksi,"select * from perjalanan order by tanggal = '$tgl' desc");
						}
